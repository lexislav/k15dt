                    ...
                    <article class="m-reference">
                        <header>
                            ...
                            <div class="m-item--summary">
                                ...
                                <div class="m-item--description">
                                    <p><?php if (isset($reference['entity']->field_reference_perex[$node->language][0]['value'])) {
                                        ...
                                        ?>
                                        <br />
                                        <a href="<?= $GLOBALS['base_url'] ?>/node/<?= $reference['entity']->nid ?>">Detail reference</a> &rarr; [
                            ...
                            <div class="m-properties">
                                <dl>
                                    <dt>Zařazení</dt><dd><?= $polejmen[$reference['entity']->field_reference_kategorie_stavby['und'][0]['tid']]->name ?> – <?= $polejmen[$reference['entity']->field_reference_kategorie_stavby['und'][1]['tid']]->name ?></dd>
                                </dl>

                                <dl>
                                    <dt>Rok realizace</dt><dd><?= $rok ?></dd>
                                </dl>

                                <dl>
                                    <dt>Země realizace</dt><dd><?= $polezemi[$reference['entity']->field_reference_zeme['und'][0]['iso2']] ?></dd>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <?php if (isset($reference['entity']->field_reference_plocha['und'][0]['value'])) { ?>
                                        ...
                                        <dd><?= $reference['entity']->field_reference_plocha['und'][0]['value'] ?> m<sup>2</sup></dd>
                                    <?php } ?>
                                </dl>
                            </div>
                        </header>
