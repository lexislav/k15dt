        ...
        <div class="m-contact-tab--address">
            <div class="m-address">
                ...
                <?php if(($fields['field_kontakt_pevna']->content!='')){?><div class="m-address--phone"><span>T</span> <?=$fields['field_kontakt_pevna']->content?></div><?php } ?>
                <?php if(($fields['kontakt_telefon']->content!='')){?><div class="m-address--phone"><span>M</span> <?=$fields['kontakt_telefon']->content?></div><?php } ?>
                <?php if(($fields['kontakt_fax']->content!='')){?><div class="m-address--fax"><span>F</span> <?=$fields['kontakt_fax']->content?></div><?php } ?>
