        ...
        foreach ($items AS $pole) {
            ...
            <div class="m-card_standard l-single">
                ...
                <article class="m-story">
                    <header>
                        <div class="m-item--image"
                             style="background-image: url(<?= image_style_url('x282-181', $cast['field_hpc_1_img']['#items'][0]['uri']) ?>)">
                            <a href="<?= $cast['field_hpc_1_odkaz']['#items'][0]['value'] ?><!--"
                               title="<?= $cast['field_hpc_1_nadpis']['#items'][0]['value'] ?>">
                                <img
                                    src="<?= image_style_url('x282-181', $cast['field_hpc_1_img']['#items'][0]['uri']) ?>"
                                    alt=""/>
                            </a>
                        </div>
                        <div class="m-item--summary">
                            <h1 class="m-item--hed">
                                <a href="<?= $cast['field_hpc_1_odkaz']['#items'][0]['value'] ?>"
                                   title="<?= $cast['field_hpc_1_nadpis']['#items'][0]['value'] ?>"><?= $cast['field_hpc_1_nadpis']['#items'][0]['value'] ?></a>
                            </h1>
                ...
                <div class="m-card--more">
                    <a href="<?= $cast['field_hpc_1_odkaz']['#items'][0]['value'] ?>"
                       title="<?= $cast['field_hpc_1_nadpis']['#items'][0]['value'] ?>"><i class="fa">&rarr;</i></a>
                </div>
