    ...
    <article class="m-contact">
        <header>
            ...
            <div class="m-contact--image" style="background-image: url(<?= image_style_url('x294-226', $content['field_image']['#items'][0]['uri']) ?>)">
                <a href=""><img src="<?= image_style_url('x294-226', $content['field_image']['#items'][0]['uri']) ?>" alt=""/></a>
            </div>

            <div class="m-contact--map" style="background-image: url(<?= image_style_url('x294-226', $content['field_image']['#items'][1]['uri']) ?>)">
                <a href="https://www.google.cz/maps/place/KOMA+MODULAR+s.r.o./@49.212273,17.862165,17z/data=!3m1!4b1!4m2!3m1!1s0x4713774877b90479:0xf22380988353fbe9"><img src="<?= image_style_url('x294-226', $content['field_image']['#items'][1]['uri']) ?>" alt=""/></a>
            </div>
...
//          dsm($content);
//          dsm($node);
//          $wfblock = module_invoke('webform', 'block_view', 'client-block-1626');
//          print render($wfblock['content']);
                ...
                <header>
                    ...
                    <div class="m-item--summary">
                        ...
                        <div class="m-card--more bg-8">
                            <a href="<?=drupal_get_path_alias('firma-a-lide/kariera')?>" title="<?php print t('Aktuální volná místa') ?>"><?php print t('Aktuální volná místa') ?>&nbsp;→</a>
                        </div>
                    </div>
                </header>
